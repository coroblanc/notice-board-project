...
public class DBConnectionMgr {
	...
	final static String DBUID = "SOLUSER";
	final static String DBPWD = "SOLUSER";

    private String _driver   = DBDRIVER;
    private String _url      = DBURL;
    private String _user     = DBUID;
    private String _password = DBPWD;
